...
const SubcategoryForm = () => {
  ...
  const fetchCategories = async () => {
    try {
      ...
      console.log(data);
      setCategories(data);
      const defaultCategory = data.find((category) => category.categoryName.toLowerCase() === "browse");
    ...
    <div className={`${styles.formContainer} ${styles.shadow}`}>
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <div className={`${styles.inputGroup} ${styles.selectContainer}`}>
          ...
          <select id="category" onChange={handleCategoryChange} value={selectedCategory?.categoryId || ""}>
